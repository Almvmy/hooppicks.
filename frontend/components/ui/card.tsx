...
function Card({
  ...
  return (
    <div
      data-slot="card"
      data-size={size}
      // SEUL CHANGEMENT : "bg-card ring-1 ring-foreground/10" → "glass",
      // et rounded-xl → rounded-2xl (le verre demande des rayons plus
      // généreux pour que le liseré spéculaire se lise sur la courbe).
      className={cn(
